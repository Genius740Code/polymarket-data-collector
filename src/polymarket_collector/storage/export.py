...
# NOTE (audit 2026-09-21): aggregate_5min_to_timeframe /
# export_timeframe_aggregates / _compute_timebucket_ms removed — dead code with
# no callers that derived larger timeframes by taking the FIRST 5m row per
# bucket (mislabeled TWAP). Native per-lane collection replaced it.
